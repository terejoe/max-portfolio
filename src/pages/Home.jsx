  ...
  return (
    <div className='w-full h-screen bg-[#191932]'>
      ...
      <div className='max-w-[750px] md:pl-40 px-6 flex justify-center text-left flex-col h-full'>
        ...
        <a href="" smooth={true} duration={500}><button className='text-[#1469FF] group border-2 px-6 py-3 flex items-center my-2 border-[#1469FF] uppercase text-sm'>View Resume<GoArrowUpRight className='ml-3' size={18}/></button></a>

      </div>

      <div className='bottom-0 hidden md:block relative'>
        <div className='left-0 bottom-0 absolute px-40 py-6'>
        <a href="#projects" smooth={true} duration={500}><FaArrowDownLong size={30} className='fill-[#ADB5BD] bounce cursor-pointer'/></a>
        </div>
