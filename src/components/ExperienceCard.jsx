...
export default function ExperienceCard({role, period, itemOne, itemTwo, itemThree, itemFour}) {
  return (
    <div className='col-span-10 mb-4'>
      ...
      <div className='md:pl-20 pl-16 text-[#ADB5BD] pr-1 text-sm md:text-base'>
        <li>{itemOne}</li>
        <li> {itemTwo} </li>
        <li>{itemThree}</li>
        <li>{itemFour}</li>
